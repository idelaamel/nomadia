...
public class DebugController {
    ...
    public String debugEnvironment() {
        ...
        result.append("SPRING_PROFILES_ACTIVE: ").append(springProfile != null ? springProfile : "NOT SET")
                .append("<br>");
        result.append("PORT: ").append(port != null ? port : "NOT SET").append("<br><br>");

        // Check system properties
        String activeProfiles = System.getProperty("spring.profiles.active");
        result.append("System spring.profiles.active: ").append(activeProfiles != null ? activeProfiles : "NOT SET")
                .append("<br>");
